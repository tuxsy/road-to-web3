...
export default function Home() {
  ...
  const contractAddress = "0x4a37Cd862BdC374289C0C7254fa649e914E32416";
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy Bruno a Coffee!</title>
        <meta name="description" content="Tipping site" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
      <img src="https://avatars.githubusercontent.com/u/25590917" style={{borderRadius: '50%'}} width="200"></img>
